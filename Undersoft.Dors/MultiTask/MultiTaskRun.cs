...
namespace System.Dors.MultiTask
{
    public static class MultiTaskRun
    {
        ...
        {
            //MultiTaskGo antGo = new MultiTaskGo("System.Dors.MultiTask.FirstCurrency", "GetFirstCurrency", new Dictionary<string, object> { { "currname", "EUR" }, { "days",      14 } } );
            ...
            {
                new MultiTaskMethod("System.Dors.MultiTask.FirstCurrency", "GetFirstCurrency"),
                new MultiTaskMethod("System.Dors.MultiTask.SecondCurrency", "GetSecondCurrency"),
            ...
            {
                new MultiTaskMethod("Compute", "System.Dors.MultiTask.ComputeCurrency"),
                new MultiTaskMethod("Present", "System.Dors.MultiTask.PresentResult")
            },
            ...
            download["GetFirstCurrency"].Worker.AddEvoker(compute["System.Dors.MultiTask.ComputeCurrency.Compute"], ComputeRequirement);

            download["GetSecondCurrency"].Worker.AddEvoker(compute["System.Dors.MultiTask.ComputeCurrency.Compute"], ComputeRequirement);
