...
namespace System.Dors.Drive
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            var server = new DriveCircular("E:\\MAPTEST.TREL", name, count, size);
            ...
            Action clientAction = () =>
            {
                ...
                var client = new DriveCircular("E:\\MAPTEST.TREL", name);
            ...
            Action serverWrite = () =>
            {
                ...
                var writer = (serverIndex == 1 ? server : new DriveCircular("C:\\MAPTEST.TREL", name));
                bool done = false;
