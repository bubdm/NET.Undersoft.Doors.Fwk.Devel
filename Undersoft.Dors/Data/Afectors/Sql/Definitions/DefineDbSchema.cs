...
namespace System.Dors.Data.Afectors.Sql
{
    ...
    public class DbConfig
    {
        ...
        public DbConfig(string _User, string _Password, string _Source, string _Catalog, string _Provider = "SQLNCLI11")
        {
            ...
            Source = _Source;
            Catalog = _Catalog;
            DbConnectionString = string.Format("Provider={0};Data Source = {1}; Persist Security Info=True;Password={2};User ID = {3}; Initial Catalog = {4}", Provider, Source, Password, User, Catalog);
        }
