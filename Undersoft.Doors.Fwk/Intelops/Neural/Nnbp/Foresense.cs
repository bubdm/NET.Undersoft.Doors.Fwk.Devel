...
namespace System.Doors.Intelops
{
    public class Foresense
    {
        ...
        public Foresense(int numInput, int numHidden, int numOutput)
        {
            ...
            ihPrevWeightsDelta = MakeMattab(numInput, numHidden);
            hPrevBiasesDelta = new double[numHidden];
            hoPrevWeightsDelta = MakeMattab(numHidden, numOutput);
        ...
        public static double[][] MakeMattab(int rows, int cols)
        {
