...
namespace System.Doors.Data.Afectors.Sql
{
    public class DbColumns
    {
        ...
        public List<DataPylon> GetDataPylons(string ColumnNames)
        {
            return list.Where(c => ColumnNames == c.ColumnName).SelectMany(r => r.DataPylons).ToList();
        }
        public List<DataPylon> GetDataPylons(List<string> ColumnNames)
        {
            return list.Where(c => ColumnNames.Contains(c.ColumnName)).SelectMany(r => r.DataPylons).ToList();
        }
    }
    ...
    public class DbColumn
    {
        ...
        public List<DataPylon> DataPylons { get; set; }
    }
